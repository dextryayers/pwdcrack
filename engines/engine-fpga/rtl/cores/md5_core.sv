...
module md5_core (
    ...
    // Shift amounts per round group
    function automatic [4:0] s(input [5:0] r);
        case ({r[5:4], r[1:0]})
            6'b00_00: return 5'd7;
            6'b00_01: return 5'd12;
            6'b00_10: return 5'd17;
            6'b00_11: return 5'd22;
            6'b01_00: return 5'd5;
            6'b01_01: return 5'd9;
            6'b01_10: return 5'd14;
            6'b01_11: return 5'd20;
            6'b10_00: return 5'd4;
            6'b10_01: return 5'd11;
            6'b10_10: return 5'd16;
            6'b10_11: return 5'd23;
            6'b11_00: return 5'd6;
            6'b11_01: return 5'd10;
            6'b11_10: return 5'd15;
            6'b11_11: return 5'd21;
            default:  return 5'd7;
        endcase
    endfunction

    // g index per round group (which message word to use)
    ...
    always_ff @(posedge clk or negedge rst_n) begin
        if (!rst_n) begin
            ...
            for (int r = 0; r < 64; r++) begin
                ...
                temp = a_pipe[r] + f + msg_word[g_idx] + K[r];
